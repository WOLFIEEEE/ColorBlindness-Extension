  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="p-3 bg-beige dark:bg-warm-brown/10 rounded-lg space-y-2 text-sm">
          <div className="flex justify-between items-center">
            <span className="text-warm-brown dark:text-cream/80">Toggle Eyedropper</span>
            <kbd className="px-2 py-1 bg-white dark:bg-dark rounded text-xs font-mono border border-border dark:border-warm-brown/30">
              Ctrl+Shift+E
            </kbd>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-warm-brown dark:text-cream/80">Scan Page</span>
            <kbd className="px-2 py-1 bg-white dark:bg-dark rounded text-xs font-mono border border-border dark:border-warm-brown/30">
              Ctrl+Shift+S
            </kbd>
          </div>
